...
| -----                | ----------------       | -----------              | ---------    |
| Data Scientist       | Author                 | [`Andre Bittencourt`]            | [`andre.bittencourt@neoway.com.br`] |
...
```
git clone https://github.com/<@github_username>/codeNation_analytics.git
cd codeNation_analytics
```
...
* [codeNation_analytics](./codeNation_analytics/): main Python package with source of the model.

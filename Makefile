IMAGE = codeNation_analytics
PACKAGE = codeNation_analytics
...
help:
	...
	@echo "    PARAMS             Parameters to pass as: $ codeNation_analytics <command> $(PARAMS)."
...
clean: clean-dist
	rm -rf codeNation_analytics.egg_info

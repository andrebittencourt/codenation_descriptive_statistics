...
sphinx-apidoc -f -e -o docs/source/apidoc/ codeNation_analytics/
...
sed -i '0,/codeNation_analytics/s//API/' docs/source/apidoc/modules.rst
# Show package's name in the home page
sed -i '0,/project/s//codeNation_analytics/' docs/source/index.rst
# Generate html docs
make -C docs/ html
